...
\section{\faPieChart}{Work Experience}
  ...
  \resumeEntryStart
    ...
    \resumeItemListStart
      ...
      \resumeItem {Spearheaded PGP implementation for secure communication with external entities}
...
\section{\faFlask}{Projects}
  ...
  \resumeEntryStart
    ...
    \resumeItemListStart
      \resumeItem{Developed a tool to generate \& provision a network of systems that are assigned random vulnerablities to create a replayable mini-CTF. These VMs are all aware of each other \& some of the vulnerabilities require the previous VM to be vulnerable in a certain away}
  ...
  \resumeEntryStart
    ...
    \resumeItem{Exploited 3rd party camera firmware allowing unauthenticated access to video feed}
    \resumeItem{Exploited bad SQL parameter scrubbing to perform SQL injection leading to admin access to main WordPress website used by teachers \& faculty to communicate with students \& host content}
    \resumeItemListEnd
  \resumeEntryEnd
